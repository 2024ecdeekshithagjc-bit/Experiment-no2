...
## 2. Circuit:
![Image description](https://github.com/2024ecdeekshithagjc-bit/Experiment-no2/blob/main/circuit%203.png?raw=true)
...
For M1 to be SATURATION, VGS1 >= VTH
0.61 V >= 0.36 V
